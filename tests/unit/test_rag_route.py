...
class TestRAGQueryRoute:
    ...
    async def test_returns_200_with_valid_query(self) -> None:
        """有効なクエリで 200 が返ること。"""
    ...
    async def test_passes_document_id_to_pipeline(self) -> None:
    ...
    async def test_defaults_top_k_to_5(self) -> None:
    ...
    async def test_returns_502_when_pipeline_fails(self) -> None:
