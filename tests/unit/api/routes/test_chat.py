...
class TestChatRouteNonStreaming:
    ...
    async def test_returns_usage_when_available(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
    ...
    async def test_returns_null_usage_when_not_available(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
    ...
    async def test_converts_messages_to_internal_format(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
    ...
    async def test_returns_422_for_invalid_role(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
    ...
    async def test_returns_422_for_missing_messages(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
    ...
    async def test_returns_502_when_llm_provider_fails(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
    ...
    async def test_defaults_stream_to_false(self, client: AsyncClient, test_app: FastAPI) -> None:
...
class TestChatRouteStreaming:
    ...
    async def test_returns_200_with_event_stream_content_type(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
    ...
    async def test_yields_sse_formatted_chunks(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
        """SSE 形式 (data: {...}\\n\\n) のチャンクが返ること。"""
        chunks = [
    ...
    async def test_ends_with_done(self, client: AsyncClient, test_app: FastAPI) -> None:
    ...
    async def test_chunk_content_matches_provider_output(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
    ...
    async def test_returns_422_for_invalid_request(
        self, client: AsyncClient, test_app: FastAPI
    ) -> None:
