...
class TestChatRouteNonStreaming:
    ...
    async def test_returns_200_with_valid_request(self) -> None:
        """有効なリクエストで 200 が返ること。"""
    ...
    async def test_returns_content_from_llm_provider(self) -> None:
    ...
    async def test_returns_model_name(self) -> None:
    ...
    async def test_returns_usage_when_available(self) -> None:
    ...
    async def test_returns_null_usage_when_not_available(self) -> None:
    ...
    async def test_converts_messages_to_internal_format(self) -> None:
    ...
    async def test_returns_422_for_invalid_role(self) -> None:
    ...
    async def test_returns_422_for_missing_messages(self) -> None:
    ...
    async def test_returns_502_when_llm_provider_fails(self) -> None:
    ...
    async def test_defaults_stream_to_false(self) -> None:
...
class TestChatRouteStreaming:
    ...
    async def test_returns_200_with_event_stream_content_type(self) -> None:
    ...
    async def test_yields_sse_formatted_chunks(self) -> None:
        """SSE 形式 (data: {...}\\n\\n) のチャンクが返ること。"""
        chunks = [
    ...
    async def test_ends_with_done(self) -> None:
    ...
    async def test_chunk_content_matches_provider_output(self) -> None:
    ...
    async def test_returns_422_for_invalid_request(self) -> None:
